...
The frontend SHALL display a tabbed interface with exactly two tabs: "Create Task" and "Search Tasks". The "Search Tasks" tab SHALL be active by default. Clicking a tab SHALL switch the visible content without a page reload.
