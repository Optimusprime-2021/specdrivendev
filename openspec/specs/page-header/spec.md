...
## Purpose
Defines the application header displayed at the top of every page, including branding (title and tagline), styling (gradient blue background), and responsive behavior.
